 ...
 *
 * @version $Id: ContaProjetoController.php 933 2013-08-16 16:28:48Z helion $
 */
class Relatorio_ContaProjetoController extends App_Controller_Default
{
    /**
     *
     * @var type 
     ...
     * @var string
     */
    const TITULO = 'Financeiro Projeto';
    ...
    protected function _getForm( $action )
    {
        if ( null == $this->_form ) {
            ...
            $this->_form = new Relatorio_Form_ContaProjeto();
	...
	$this->view->data = $this->_mapper->agrupaLancamentosRelatorioContaProjeto( $data );
	...
	$html->data 	= $this->_mapper->agrupaLancamentosRelatorioContaProjeto( $data );
	
	$domPdf = new App_General_DomPDF( 'a4', 'landscape' );
	$domPdf->loadHtml( $html->render( 'conta-projeto/relatorio.phtml' ) );
	$domPdf->download( 'Relatorio_Conta_Projeto_' . date('d_m_Y_H_i') . '.pdf' );
	...
	App_General_Util::toExcell( 'Relatorio_Conta_Projeto_' . date('d_m_Y_H_i'), $html->render( 'conta-projeto/body.phtml' ) );
